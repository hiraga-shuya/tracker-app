...
INSERT INTO "new_Habit_Task" ("created_at", "deleted_at", "id", "is_active", "name", "updated_at", "userId") SELECT "created_at", "deleted_at", "id", "is_active", "name", "updated_at", "userId" FROM "Habit_Task";
